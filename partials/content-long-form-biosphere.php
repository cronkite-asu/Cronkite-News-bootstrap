  ...
  <div class="grid-x grid-padding-x">
    ...
    <div class="large-12 medium-12 small-12 cell text-center">
      <span class="photo-credit"><?php echo get_sub_field('credits'); ?></span>
            ...
            <?php
        } elseif (get_row_layout() == 'intro-scale' ) {
            ?>
<div id="intro-scale" class="grid-container full show-for-medium">
  <div class="grid-x grid-padding-x">
            <?php if (get_sub_field('photo') != '') { ?>
    <div class="large-12 medium-12 small-12 cell photo-container">
      <div class="headline-container">
        <div class="headline">
            <h2 data-text="BIOSPHERE 2">Biosphere 2</h2>
            <h1><?php echo get_sub_field('headline'); ?></h1>
        </div>
      </div>
...
<div id="intro-scale-small" class="grid-container full show-for-small-only">
  <div class="grid-x grid-padding-x">
            <?php if (get_sub_field('photo') != '') { ?>
    <div class="large-12 medium-12 small-12 cell photo-container">
      <div class="photo-holder"></div>
  ...
  <div class="grid-container video-content <?php echo $videoWidth; ?>">
    <div class="grid-x grid-padding-x">
      ...
      <div class="large-12 cell">
            ...
            } else if ($settings['video-player'] == 'plyr-embed' && get_sub_field('embed') == '') {
                ?>
        ...
        <div class="large-12 cell">
            ...
            <?php
        } elseif (get_row_layout() == 'video-2up-content' ) {
            ...
            ?>
  <div class="grid-container video-2up <?php echo $videoWidth; ?>">
    <div class="grid-x grid-padding-x">
            <?php
            if ($settings['video-player'] == 'regular-embed' || $settings['video-player'] == '') {
            } else {
    ...
    <div class="grid-container fullscreen-photo-content show-for-medium">
      <div class="grid-x grid-padding-x">
        <div class="large-12 medium-12 small-12 cell">
            <?php
              $captionCounter = 0;
          ...
          <div class="process-wrap">
            ...
            <?php } ?>
        <div class="large-12 medium-12 small-12 cell" style="max-width: 46.875rem;margin:0 auto;">
          <div class="wp-caption-text"><p>The pyramid-shaped building at Biosphere 2 holds the indoor rainforest, where Joost van Haren and his team of student engineers from UArizona are testing their methane-measuring devices. (Photo illustration, based on rendering courtesy of University of Arizona Biosphere 2, and photo by <a href="https://cronkitenews.azpbs.org/people/hope-obrien/" rel="noopener" target="_blank">Hope O’Brien</a>/Cronkite News)</p></div>
        </div>
      </div>
    </div>
    ...
    <div class="grid-container sidexside-content">
      <div class="grid-x grid-padding-x align-middle">
          ...
          <div class="large-6 small-12 cell text-center">
            ...
            <?php
        } elseif (get_row_layout() == 'table-video-content' ) {
    ...
    <div class="grid-container sidexside-content">
      <div class="grid-x grid-padding-x align-middle">
            <?php if ($settings['order'] == 'photo-left') { ?>
          <div class="large-6 small-12 cell text-center">
            <video autoplay muted playsinline crossorigin loop><source src="<?php echo get_sub_field('video'); ?>" type="video/mp4" /></video>
          </div>
          <div class="large-6 small-12 cell align-self-stretch content-bg">
                <?php echo get_sub_field('content');    ?>
          </div>
    ...
    <div class="grid-container text-content charts-doc desktop <?php echo $visibilityDesktop; ?>">
      <div class="grid-x grid-padding-x">
        <div class="large-12 cell">
    ...
    <div class="grid-container large-photo-verticals">
      <div class="grid-x grid-padding-x align-middle">
        ...
        <div class="large-12 cell">
            ...
            <?php
        } elseif (get_row_layout() == 'horizontal-photos-vertical' ) {
            $verticalSettings = get_sub_field('vertical-photo');
            ?>

    <div class="grid-container horizontal-photos-vertical">
      <div class="grid-x grid-margin-x align-middle">

            <?php
            $captionCounter = 0;
            if (have_rows('horizontal-photos') ) {
                ?>
          <div class="large-8 medium-8 small-12 cell">
            ...
            <?php if ($verticalSettings['photo'] != '') { ?>
        <!-- vertical -->
        <div class="large-4 medium-4 small-12 cell">
          <div class="grid-x grid-margin-x">

                <?php if (get_sub_field('small-photo') != '') { ?>
              <div class="large-12 medium-12 small-12 cell">
                <img src="<?php echo get_sub_field('small-photo'); ?>"  />
                    <?php echo '<div class="wp-caption-text">'.get_sub_field('caption-small').'</div>'; ?>
              </div>
                <?php } ?>

            <div class="large-12 medium-12 small-12 cell">
              <img src="<?php echo $verticalSettings['photo']; ?>"  />
                <?php echo '<div class="wp-caption-text">'.$verticalSettings['caption'].'</div>'; ?>
            </div>
