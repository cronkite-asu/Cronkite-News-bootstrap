...
<div class="grid-container full bg-holder">
  <div class="grid-x grid-padding-x">
    <div class="large-12 cell text-center">
      <h1 style="line-height:5rem;margin-bottom: 0px;padding-bottom: 40px;">Panama:<br >Migrants’ Toughest Test</h1>
      <p>Panama has become the key transit point for a great worldwide migration of people hoping to reach the United States or Canada. Migrants from around the globe have converged on the small isthmus that forms the dividing line between North and South America, believing it is their best hope to join the flow northward. But before their journey can continue they must cross the world’s deadliest jungle, face off with murderous bandits, and experience their first encounter with the long arm of the U.S. border protection system. Many will not make it through.</p>
      <style>
        .panama-team {
      ...
      <p><a class="panama-team" href="https://cronkitenews.azpbs.org/panama-migrants-toughest-test/panama-bios/">Panama Team</a></p>
    </div>
  </div>
</div>
