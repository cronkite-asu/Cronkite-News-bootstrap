...
?>
    <div class="grid-container vertical-two-squares-block">
      ...
      <div class="grid-x grid-padding-x">
        <div class="large-12 medium-12 small-12 cell">
          <div class="wp-caption-text show-for-medium"><?php echo get_sub_field('caption'); ?></div>
          <div class="wp-caption-text show-for-small-only"><?php echo get_sub_field('caption-mobile'); ?></div>
        </div>
      </div>
    </div>
