    ...
    <footer class="grid-container full-width">
      <div class="grid-x grid-padding-x">
        <div class="large-3 medium-3 small-6 cell">
          <h6>Quienes somos</h6>
          <p>Cronkite Noticias, una división de <a href="https://azpbs.org/" target="_blank">Arizona PBS</a>S, es producido por <a href="https://cronkite.asu.edu/" target="_blank">Walter Cronkite School of Journalism and Mass Communication</a> de <a href="https://www.asu.edu/" target="_blank">Arizona State University</a>.</p>
          <p>Lista de <a href="https://cronkitenews.azpbs.org/about-us/" target="_blank">personal</a>.</p>
        </div>

        <div class="large-3 medium-3 small-6 cell">
          <h6>Qué hacemos</h6>
          <p>Obtenga más <a href="https://cronkitenews.azpbs.org/what-we-do/" target="_blank">información</a> sobre lo que hacemos y cómo encontrar nuestro contenido de televisión y plataformas digitales y redes sociales.</p>

          <h6 class="inside">Uso del contenido</h6>
          <p>Descubra cómo su organización de noticias puede utilizar el contenido de <a href="https://cronkitenews.azpbs.org/use-our-content/" target="_blank">Cronkite Noticias</a>.</p>
        </div>
        ...
        <div class="large-3 medium-3 small-6 cell">
          ...
          <p>602.496.5050</p>
          <p><a href="mailto:cronkitenoticias@asu.edu">cronkitenoticias@asu.edu</a></p>
        </div>
      ...
      <div class="grid-x grid-margin-x copyright-section">
        <div class="large-4 cell">
          <p class="copyright">&copy; <?php echo date('Y'); ?> Cronkite News. Todos los derechos reservados.</p>
        </div>
        <div class="large-4 medium-4 small-12 cell">
          <p><a href="https://creativecommons.org/licenses/by-sa/3.0/" target="_blank">Creative Commons</a> <a href="https://www.asu.edu/privacy/" target="_blank">Declaración de privacidad</a></p>
        </div>
        <div class="large-4 medium-4 small-12 cell text-right">
          <ul class="social-links no-bullet">
            <li><a href="https://twitter.com/CronkNoticias" target="_blank"><i class="fab fa-twitter"></i></a></li>
            <li><a href="https://www.instagram.com/cronknoticias/" target="_blank"><i class="fab fa-instagram"></i></a></li>
            <li><a href="https://www.facebook.com/CronkiteNoticias" target="_blank"><i class="fab fa-facebook"></i></a></li>
            <li><a href="https://www.youtube.com/channel/UC2Iqah0ezokMG1gJH0iZAWA" target="_blank"><i class="fab fa-youtube"></i></a></li>
          </ul>
        </div>
      </div>
    </footer>
